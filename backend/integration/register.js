...
export function registerAllSenderBranches({ app, models, authenticate, checkPermission = null, encryptIntegrationSecret, resolveIntegrationSecret, integrationEncryptionKey, basePath = '/api/branches', externalBasePath = '/api/branch-data' }) {
  ...
  const module = createBranchesModule({ host, checkPermission });
